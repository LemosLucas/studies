            ...
            _export('DateHelper', DateHelper = function () {
                ...
                _createClass(DateHelper, null, [{
                    ...
                    value: function textoParaData(texto) {
                        ...
                        if (!dateRegex.test(texto)) throw new Error('Data format should be yyyy-mm-dd');
                        ...
                        return new (Function.prototype.bind.apply(Date, [null].concat(_toConsumableArray(texto.split('-').map(function (element, index) {
